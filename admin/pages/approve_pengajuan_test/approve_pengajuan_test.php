            ...
            <table id="example" class="table table-bordered" width="100%">
                ...
                <tbody>
                    ...
                    $id = $r['id'];
                        ...
                        $sql2 = mysql_query("
                            SELECT count(a.no_ktp)hasil,b.hasil_test,date(b.create_time)tgl  FROM datapribadi_ck a
                            left join
                            (select *from datapribadi_ck)b on a.no_ktp=b.no_ktp
                            where  a.no_ktp='$no_ktp' and b.status='approve2'
                            ;");
                        while ($r2 = mysql_fetch_row($sql2)) {
                            $hitung_double=$r2[0];
                            $hasil_test_doble=$r2[1];
                            $hasil_tgl_doble=$r2[2];
                    ?>
                    ...
                    <tr align='left'>
                        <td>
                            ...
                            echo  $r[5]; echo "<br><br>";
                            if ($hitung_double>1) {
                                echo "<p style='color:red'>Pernah Mengikuti Test Dengan Hasil : $hasil_test_doble <br> Tanggal : $hasil_tgl_doble</p>";
                            }
                            ?>
                        </td>
                        <td><?php echo  $r[7]; ?></td>
