...
include('../../session.php');
include('../../koneksi.php');
include('ajaxupdate/ajax_kirim_lainlain.php');
?>
...
while($rows = mysql_fetch_array($sql))
{
  ...
  <div class="row row-form" id="">
    ...
    <div class="col-xs-12 col-sm-8">                                    
        <textarea id="skill" name="skill" placeholder="skill" type="text"<?php echo $readonly ?> <?php echo $background ?> class="form-control"  style="text-transform:uppercase;height:100px;resize:none;"><?php echo $rows['skill'] ?></textarea>
        <span class="text-danger"></span>
    </div>
  </div>
    ...
    <div class="col-xs-12 col-sm-12">
      <label for="skill" class="menu_label"><li>Bila Saudara diterima bekerja, apakah Saudara bersedia memberikan jaminan kerja berupa Ijasah Asli selama masa bekerja ?</li></label>
		...
		<div class="col-xs-12 col-sm-5">                                    
			<input id="syarat_ijasah" name="syarat_ijasah" value="<?php echo $rows['pemberian_jaminan'] ?>" <?php echo $readonly ?> <?php echo $background ?> type="text" class="form-control"/>
			<span class="text-danger"></span>
		</div>
  </div>
...
<Br>
  <div class="row row-form" id="">
    ...
    <table border="0" style="color: white; padding-left: 25px;">
      ...
      <tbody>
        <td><input type="text" class="form-control" name="nama_kenalan" id="nama_kenalan" value="<?php echo $rows['nama_kenalan'] ?>" <?php echo $readonly ?>  style="color: black;font-weight: lighter;"></td>
        <td><input type="text" class="form-control" name="hubungan_kenalan" id="hubungan_kenalan" value="<?php echo $rows['hubungan_kenalan'] ?>" <?php echo $readonly ?> style="color: black;font-weight: lighter;"></td>
        <td><input type="text" class="form-control" name="jabatan_kenalan" id="jabatan_kenalan" value="<?php echo $rows['jabatan_kenalan'] ?>" <?php echo $readonly ?> style="color: black;font-weight: lighter;"></td>
      </tbody>  
    </table>
  </div>
  ...
  <div class="row row-form">
    ...
    <div class="col-xs-12 col-sm-10">                                    
      <input id="prestasi_ck" name="prestasi_ck" type="text" class="form-control" value="<?php echo $rows['prestasi_ck'] ?>" <?php echo $readonly ?> <?php echo $background ?> style="text-transform:uppercase"/>
      <span class="text-danger"></span>
    </div>
  </div>
  ...
  <div class="row row-form">
    ...
    <div class="col-xs-12 col-sm-10">                                    
      <input id="kelebihan_prestasi_ck" name="kelebihan_prestasi_ck" type="text" class="form-control" value="<?php echo $rows['tiga_kelebihan'] ?>" <?php echo $readonly ?> <?php echo $background ?> style="text-transform:uppercase"/>
      <span class="text-danger"></span>
    </div>
  </div>
  ...
  <div class="row row-form">
    ...
    <div class="col-xs-12 col-sm-10">                                    
      <input id="kekurangan_prestasi_ck" name="kekurangan_prestasi_ck" type="text" class="form-control" value="<?php echo $rows['tiga_kekurangan'] ?>" <?php echo $readonly ?> <?php echo $background ?> style="text-transform:uppercase" />
      <span class="text-danger"></span>
    </div>
  </div>
  ...
  <div class="row row-form">
    ...
    <div class="col-xs-12 col-sm-10">                                    
      <input id="penempatan_di_cabang" name="penempatan_di_cabang" type="text" class="form-control" value="<?php echo $rows['penempatan_di_cabang'] ?>" <?php echo $readonly ?> <?php echo $background ?> style="text-transform:uppercase"/>
      <span class="text-danger"></span>
    </div>
  </div>
  ...
  <div class="row row-form">
    ...
    <div class="col-xs-12 col-sm-10">                                    
      <input id="kesehatan" name="kesehatan" type="text" class="form-control" style="text-transform:uppercase" value="<?php echo $rows['penempatan_di_cabang'] ?>" <?php echo $readonly ?> <?php echo $background ?> />
      <span class="text-danger"></span>
    </div>
  </div>
...
<?php } ?>
  ...
  <div class="row">
    <ul class="pager" style="vertical-align: top">
      ...
      {
      ?>
      <li class="next"><a href="#step_3" onClick="save_hal4()" id="btn_2" name="btn_2">UPDATE</a></li>
      <?php } ?>
    </ul>
  </div>
