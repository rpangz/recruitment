...
<?php if ($rows['status_rumah_saudara1']=="") {
	echo "";
}
else {
?>
...
<?php if ($rows['status_rumah_saudara2']=="") {
	echo "";
}
else {
?>
...
<?php if ($rows2['status_rumah_sutri']=="") {
	echo "";
}
else {
?>
