...
?> 
            ...
            <table id="example" class="table table-bordered" width="100%">
                ...
                <tbody>
                        ...
                        $sql2 = mysql_query("SELECT b.nama_lengkap,b.telp1,b.divisi,b.bagian,b.status datapb,b.hasil_test, a.* FROM psikotest_data_kary a,datapribadi_ck b where a.no_calon_kary=b.id_calon_karyawan and date(create_time) >='" .  $_GET['cstartDate'] . "'  AND date(create_time) <='" . $_GET['cendDate'] . "' and b.status!='DIHAPUS'  ORDER BY a.start_a DESC" );
                        }
                        else{
                        /*================================= BUKA LOOP CALON KARY ========================================*/
                        $sql2 = mysql_query("SELECT b.nama_lengkap,b.telp1,b.divisi,b.bagian,b.status datapb,b.hasil_test, a.* FROM psikotest_data_kary a,datapribadi_ck b where a.no_calon_kary=b.id_calon_karyawan and date(create_time) >='" .  $_GET['cstartDate'] . "'  AND date(create_time) <='" . $_GET['cendDate'] . "' and b.status='approve2' and b.status!='DIHAPUS'  ORDER BY a.start_a DESC" );
                        }
                        $no = 1;

                        while ($r2 = mysql_fetch_array($sql2)) {
                            $status = $r2[datapb];
                            $status_soal = $r2[status];
                            ...
                            ?>
                                ...
                                <td align="center">
                                    ...
                                    <div><!-- 
                                        ...
                                        <input type="hidden" id="id_calon_karyawan" name="id_calon_karyawan" value="<?php echo  $r2['no_calon_kary'];?>">
