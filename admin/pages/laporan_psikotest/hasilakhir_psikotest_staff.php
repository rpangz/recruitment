...
<table border="0" style="border-style: groove; border-width: 0px; border-collapse: collapse;" align="center" width="500px">
  <tr>
    ...
    <th style="padding-left: 0">
          ...
          <select <?php if ($status=="approve2") { echo ' disabled="disabled"'; }?> name="hasil_test" class = "form-control" id="hasil_test" style="text-transform:uppercase" 
...
<table border="0" style="border-style: groove; border-width: 0px; border-collapse: collapse;" align="center" width="500px">
  <tr>
    <th width="10px">NOTE</th>
    <th style="padding-left: 5px" colspan="2">
        <textarea <?php if ($status=="approve2") { echo ' disabled="disabled"'; }; ?> name="catatan"
        style="width: 100%; padding-left: 10px; font-weight: bold; height:150px;width: 420px; resize:none;"><?php 
