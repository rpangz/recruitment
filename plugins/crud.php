...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="plugins/jQuery/flexigrid/css/flexigrid.css">
		<script type="text/javascript" src="plugins/jQuery/jquery.cookie.js"></script>
		<script type="text/javascript" src="plugins/jQuery/flexigrid/js/flexigrid.js"></script>
        ...
        function doaction( celDiv, id ) {
			$( celDiv ).click( function() {
				...
				$.getJSON ('crud.php',{action:'get_mhs',nim:nim}, function (json) {
					$('#nim').val(json.nim);
					$('#nama').val(json.nama);
