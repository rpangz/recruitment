...
$cabang = $input[22];
if ($id_calon_karyawan == "" || $no_ktp =="" || $nama_lengkap ==""|| $tempatlahir ==""|| $tanggal_lahir ==""|| $jen_kel ==""|| $status_perkawinan ==""|| $alamat_domisili ==""|| $alamat_ktp ==""|| $status_rumah ==""|| $warga_negara ==""|| $telp1 ==""|| $telp2 ==""|| $alamat_email ==""|| $divisi ==""|| $bagian ==""|| $sumber_lamaran ==""|| $cabang ==""){
    echo "Data Gagal Diinput";
} else {
    /*
    $query0 = mysql_query("select no_ktp from datapribadi_ck where no_ktp='$no_ktp' AND status!='approve2'");
    ...
    if ($id_calon_karyawan==$id) {
    echo "Id_Sudah_Ada_Harap_Refresh_Halaman";
